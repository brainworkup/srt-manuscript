...
#show: doc => article(
  ...
  authors: (
    ( name: [Ana Fulano],
      affiliation: [Ana and Blanca's University],
      email: [sm\@example.org] ),
    ( name: [Blanca Zutano],
      affiliation: [Ana and Blanca's University],
      email: [] ),
    ( name: [Carina Mengano],
      affiliation: [Carina's Primary Affiliation, Carina's Secondary Affiliation],
      email: [] ),
    ( name: [true],
      affiliation: [],
      email: [] ),
...
#figure([
#box(image("sampleimage.png", width: 48.0%))
], caption: figure.caption(
position: bottom, 
[
An Imported Graphic
...
#figure([
#box(image("sampleimage.png", width: 49.0%))
], caption: figure.caption(
position: bottom, 
[
